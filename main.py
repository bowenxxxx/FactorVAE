...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', default='libero_multiTask_dataAug', type=str, help='name of the experiment')
    parser.add_argument('--cuda', default=True, type=str2bool, help='enable cuda')
    parser.add_argument('--max_iter', default=1e6, type=float, help='maximum training iteration')
    parser.add_argument('--batch_size', default=256, type=int, help='batch size')

    parser.add_argument('--z_dim', default=16, type=int, help='dimension of the representation z')
    ...
    parser.add_argument('--lr_D', default=1e-5, type=float, help='learning rate of the discriminator')
